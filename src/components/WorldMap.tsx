...
const continents = [
  { id: 'AFRICA', name_en: 'Africa', name_fr: 'Afrique', name_ar: 'أفريقيا', name_es: 'África', name_zh: '非洲', countries: 54 },
  { id: 'ASIA', name_en: 'Asia', name_fr: 'Asie', name_ar: 'آسيا', name_es: 'Asia', name_zh: '亚洲', countries: 50 },
  { id: 'EUROPE', name_en: 'Europe', name_fr: 'Europe', name_ar: 'أوروبا', name_es: 'Europa', name_zh: '欧洲', countries: 44 },
  { id: 'NORTH_AMERICA', name_en: 'North America', name_fr: 'Amérique du Nord', name_ar: 'أمريكا الشمالية', name_es: 'América del Norte', name_zh: '北美洲', countries: 23 },
  { id: 'SOUTH_AMERICA', name_en: 'South America', name_fr: 'Amérique du Sud', name_ar: 'أمريكا الجنوبية', name_es: 'América del Sur', name_zh: '南美洲', countries: 12 },
  { id: 'OCEANIA', name_en: 'Oceania', name_fr: 'Océanie', name_ar: 'أوقيانوسيا', name_es: 'Oceanía', name_zh: '大洋洲', countries: 14 },
];
...
export function WorldMap() {
  ...
  return (
    <div className="relative w-full h-[70vh] min-h-[500px] rounded-2xl overflow-hidden travel-shadow">
      <div 
      ...
      <div className="absolute inset-0 flex flex-wrap items-center justify-center gap-4 p-8">
        {continents.map((continent) => (
          <button
            ...
            className="group relative bg-card/90 backdrop-blur-sm border border-border rounded-xl px-6 py-4 
